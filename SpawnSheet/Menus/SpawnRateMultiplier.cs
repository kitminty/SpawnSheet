...
namespace SpawnSheet.Menus
{
	...
	internal class SpawnRateMultiplier
	{
		...
		private static float[] multipliers = new float[] { .25f, .5f, 1f, 1.5f, 2f, 3f, 5f, 10f, 30f, 50f, 100f, 200f, 500f, 1000f, 10000f, 100000f};
		private static string[] multiplierStrings = new string[] { ".25x", ".5x", "1x", "1.5x", "2x", "3x", "5x", "10x", "30x", "50x", "100x", "200x", "500x", "1000x", "10000x", "100000x-Grant"};
