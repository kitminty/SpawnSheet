...
namespace SpawnSheet.Menus
{
	internal class PaintToolsSlot : UIView
	{
		...
		public void Select() {
			...
			SpawnSheet.instance.paintToolsUI.submitInput.Text = "";
			...
			if (CurrentSelect == this) {
				...
				isSelect = true;
				CurrentSelect = this;
				SpawnSheet.instance.paintToolsHotbar.StampTiles = stampInfo.Tiles;
				SpawnSheet.instance.paintToolsHotbar.stampInfo = stampInfo;

				// Update UI;
				if (CurrentSelect.browserID > 0) {
					SpawnSheet.instance.paintToolsUI.infoPanel.Visible = true;
					SpawnSheet.instance.paintToolsUI.infoMessage.Text = browserName + ": " + rating;
					...
					//SpawnSheet.instance.paintToolsUI.submitPanel.Visible = true;
				}
			}
		}
