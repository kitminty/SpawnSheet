...
namespace SpawnSheet.UI
{
	internal class UICheckbox : UIView
	{
		...
		public UICheckbox(string text) {
			checkboxTexture = SpawnSheet.instance.Assets.Request<Texture2D>("UI/checkBox", AssetRequestMode.ImmediateLoad);
			checkmarkTexture = SpawnSheet.instance.Assets.Request<Texture2D>("UI/checkMark", AssetRequestMode.ImmediateLoad);
